...
public class Projectile : MonoBehaviour
{
    ...
    // This private List stores the history of the projectile's positions, which is used to determine if the projectile is asleep.
    ...
    void FixedUpdate()
    {
        ...
        // If the projectile hasn't moved more than the SleepThreshold, then it's asleep
